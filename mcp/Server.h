...
struct ServerOptions {
    QJsonObject implementation{{"name", "iiLocalLLM"}, {"version", "0.30.0"}};
...
public:
    ...
    bool isClosed() const;
    bool isControlMethod(const QString&) const; // Registered host controls or ping; no permission bypass.
