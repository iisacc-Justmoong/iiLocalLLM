...
전체 MCP 요구사항의 완료 상태는 아니다. Streamable HTTP·legacy SSE·OAuth·재연결, MCP 서버의 HTTP 전송·인증, tasks, 자동 앱 발견은 남아 있다. 지원 프로토콜은 2025-11-25, 2025-06-18, 2025-03-26이다. 2026-07-28 규격은 아직 지원 목록에 넣지 않는다.
